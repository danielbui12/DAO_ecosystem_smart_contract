...
contract SwapScepter is ERC165, IERC721Receiver, IERC1155Receiver{{
    ...
    function swapCrown() external{
        ...
        currentSupply += 1;
        require(currentSupply <= MAX_SUPPLY, "SwapSceptor: Run out of CrownNFT");
        crown.mintValidTarget(1);
        uint256 firstCrownToken = crown.tokenOfOwnerByIndex(address(this), 0);
        sceptor.safeTransferFrom(msg.sender, address(this), 0, PRICE, "");
        crown.safeTransferFrom(address(this),msg.sender,firstCrownToken);
    }
